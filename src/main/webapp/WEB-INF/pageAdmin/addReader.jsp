...
<body>
	...
	<form class="layui-form" action="${baseUri}/admin/addReader.do" method="POST"
		enctype="multipart/form-data">

		<div class="layui-form-item">
			<label class="layui-form-label">用户账号</label>
			<div class="layui-input-block" style="width: 400px;">
				<input type="text" name="rCard" lay-verify="required"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block" style="width: 400px;">
				<input type="text" name="rNick" lay-verify="required"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 400px;">
				<input type="password" name="rPassword" placeholder="" autocomplete="off"
					class="layui-input">
			</div>
		</div>
		...
		<div class="layui-form-item">
	        ...
	        <div class="layui-input-inline">
	        	<input type="radio" title="男" name="rSex" value="0" checked="checked">
	        	<input type="radio" title="女" name="rSex" value="1">
	        </div>
	    </div>
